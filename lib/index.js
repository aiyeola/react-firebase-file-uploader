...
var _excluded = ["storageRef", "onUploadStart", "onProgress", "onUploadSuccess", "onUploadError", "randomizeFilename", "metadata", "filename", "maxWidth", "maxHeight", "hidden", "as"];
 ...
 */
var FirebaseFileUploader = /*#__PURE__*/function (_Component) {
  function FirebaseFileUploader(props) {
    var _this;
    _classCallCheck(this, FirebaseFileUploader);
    _this = _callSuper(this, FirebaseFileUploader, [props]);
    _defineProperty(_this, "handleFileSelection", function (event) {
      var files = event.target.files;
      if (files) {
        Array.from(files).forEach(function (file) {
          return _this.startUpload(file);
        });
      }
    });
    _this.uploadTasks = [];
  ...
  return _createClass(FirebaseFileUploader, [{
    ...
    value: function removeTask(task) {
      var index = this.uploadTasks.indexOf(task);
      if (index !== -1) {
    ...
    key: "startUpload",
    value: function () {
      var _startUpload = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(file) {
        var _this2 = this;
        var _this$props, onUploadStart, storageRef, metadata, randomizeFilename, filename, maxWidth, maxHeight, filenameToUse, processedFile, fileRef, uploadTask;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _this$props = this.props, onUploadStart = _this$props.onUploadStart, storageRef = _this$props.storageRef, metadata = _this$props.metadata, randomizeFilename = _this$props.randomizeFilename, filename = _this$props.filename, maxWidth = _this$props.maxWidth, maxHeight = _this$props.maxHeight;
              if (filename) {
              ...
              _context.prev = 3;
              if (!(file.type.match(/image.*/) && (maxWidth || maxHeight))) {
                _context.next = 10;
                break;
              }
              _context.next = 7;
              return (0, _image["default"])(file, maxWidth, maxHeight);
            case 7:
            ...
            case 10:
              _context.t0 = file;
            case 11:
              processedFile = _context.t0;
              // Create the file reference and start upload
              fileRef = (0, _storage.ref)(storageRef, filenameToUse);
              uploadTask = (0, _storage.uploadBytesResumable)(fileRef, processedFile, metadata);
              if (onUploadStart) {
              ...
              uploadTask.on("state_changed", function (snapshot) {
                if (_this2.props.onProgress) {
                  var progress = Math.round(snapshot.bytesTransferred / snapshot.totalBytes * 100);
                  _this2.props.onProgress(progress, uploadTask);
                }
              }, function (error) {
                _this2.removeTask(uploadTask);
                if (_this2.props.onUploadError) {
                  _this2.props.onUploadError(error, uploadTask);
                }
              }, function () {
                _this2.removeTask(uploadTask);
                if (_this2.props.onUploadSuccess) {
                  _this2.props.onUploadSuccess(uploadTask.snapshot.metadata.name, uploadTask);
                }
              });
            ...
            case 19:
              ...
              if (this.props.onUploadError) {
                this.props.onUploadError(_context.t1, null);
              }
            case 22:
            case "end":
    ...
    value: function render() {
      var _this$props2 = this.props,
        storageRef = _this$props2.storageRef,
        ...
        randomizeFilename = _this$props2.randomizeFilename,
        ...
        Input = _this$props2$as === void 0 ? "input" : _this$props2$as,
        props = _objectWithoutProperties(_this$props2, _excluded);
      var inputStyle = hidden ? _objectSpread(_objectSpread({}, props.style), {}, {
        width: "0.1px",
        height: "0.1px",
        opacity: 0,
        overflow: "hidden",
...
var _default = exports["default"] = FirebaseFileUploader;